...
Процедура ВыгрузитьВерсию( Знач пДанные, Знач пХранилище )
	...
	Справочники._ДействияПриКоммитеДляГитлаба.ВыполнитьДействияПоКоммитамДляГитлаба( пХранилище.ПриКоммите.ВыгрузитьКолонку( "Действие" ), пДанные.Комментарий, пХранилище );
